---
title: ブランドに即したマーケティングメールの作成
description: Adobe [!DNL GenStudio for Performance Marketing]を使用してブランドに即したマーケティングメールを作成する方法をステップバイステップで説明します。
